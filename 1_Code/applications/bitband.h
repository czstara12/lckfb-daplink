...
#define GPIOA_OUTPUT_DATA_ADDRESS    (GPIOA + 20) // GPIOA ODR 地址
#define GPIOB_OUTPUT_DATA_ADDRESS    (GPIOB + 20) // GPIOB ODR 地址
#define GPIOC_OUTPUT_DATA_ADDRESS    (GPIOC + 20) // GPIOC ODR 地址
#define GPIOD_OUTPUT_DATA_ADDRESS    (GPIOD + 20) // GPIOD ODR 地址
#define GPIOE_OUTPUT_DATA_ADDRESS    (GPIOE + 20) // GPIOE ODR 地址
#define GPIOF_OUTPUT_DATA_ADDRESS    (GPIOF + 20) // GPIOF ODR 地址
#define GPIOG_OUTPUT_DATA_ADDRESS    (GPIOG + 20) // GPIOG ODR 地址
#define GPIOH_OUTPUT_DATA_ADDRESS    (GPIOH + 20) // GPIOH ODR 地址
#define GPIOI_OUTPUT_DATA_ADDRESS    (GPIOI + 20) // GPIOI ODR 地址

// 定义各个GPIO端口的输入数据寄存器（IDR）地址
#define GPIOA_INPUT_DATA_ADDRESS     (GPIOA + 16) // GPIOA IDR 地址
#define GPIOB_INPUT_DATA_ADDRESS     (GPIOB + 16) // GPIOB IDR 地址
#define GPIOC_INPUT_DATA_ADDRESS     (GPIOC + 16) // GPIOC IDR 地址
#define GPIOD_INPUT_DATA_ADDRESS     (GPIOD + 16) // GPIOD IDR 地址
#define GPIOE_INPUT_DATA_ADDRESS     (GPIOE + 16) // GPIOE IDR 地址
#define GPIOF_INPUT_DATA_ADDRESS     (GPIOF + 16) // GPIOF IDR 地址
#define GPIOG_INPUT_DATA_ADDRESS     (GPIOG + 16) // GPIOG IDR 地址
#define GPIOH_INPUT_DATA_ADDRESS     (GPIOH + 16) // GPIOH IDR 地址
#define GPIOI_INPUT_DATA_ADDRESS     (GPIOI + 16) // GPIOI IDR 地址
